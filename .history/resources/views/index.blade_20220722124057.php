...
.box_con form table tr .opinion-box-input{
  width: 100%;
  height: 10em;
  padding: .5em;
  -moz-box-sizing: border-box;
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            ...
            <p class="notError" id="last_name_error">※名字の入力は必須です</p>
          </td>
          <td>
            <input type="text" name="first_name" value="{{ old('first_name') }}" id="last_name">
            <p class="example">例）太郎</p>
            <p class="notError" id="last_name_error">※名前の入力は必須です</p>
          </td>
        </tr>
        <tr>
          <th>性別<span >※</span></th>
        ...
        <tr>
          ...
          <td colspan="2" class="postcode-box">
            <div>
              <span>〒</span><input type="text" name="postcode" value="{{ old('postcode') }}" class="postcode-box-input p-postal-code" size="8" maxlength="8">
            </div>
        ...
        <tr>
          <th>住所<span >※</span></th>
          <td colspan="2">
            <input type="text" name="address" value="{{ old('address') }}" class="p-region p-locality p-street-address p-extended-address">
        ...
        <tr>
          <th>ご意見<span >※</span></th>
          <td colspan="2">
            <input type="text" name="opinion" value="{{ old('opinion') }}" class="opinion-box-input">
          </td>
        </tr>
      </table>
