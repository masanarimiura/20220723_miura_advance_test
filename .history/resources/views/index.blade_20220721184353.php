      ...
      <table>
        ...
        <tr>
          ...
          <td colspan="2" class="postcode-box">
            <div>
              <span>〒</span><input type="text" name="postcode" value="{{ old('postcode') }}" class="postcode-box-input" oninput="cman_string()">
            </div>
...
<script>
function inputChange(event.currentTarget.value){
  ...
  '`','@','\\{','\\[','｢','\\+',';','\\*',':','\\}','\\]','｣','<',',','､','>','\\.','｡','\\?','･','\\/','_');
  var bef = befnum.concat(befkigo);
  var aft = aftnum.concat(aftkigo);
  ...
  textIn = textIn.replace(/￥/g,"\\");
  document.getElementById("textOut").value = textIn;
}
</script>
</body>
</html>