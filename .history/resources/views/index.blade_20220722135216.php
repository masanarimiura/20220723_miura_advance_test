...
<script>
  window.addEventListener('DOMContentLoaded', function(){
    ...
    email.addEventListener("input",function(){
      ...
      if(/^[A-Za-z0-9]{1}[A-Za-z0-9_.-]*@{1}[A-Za-z0-9_.-]+.[A-Za-z0-9]+$/.test(this.value)){
        postcode_error.className = 'notError';
      } else if(/^[A-Za-z0-9]{1}[A-Za-z0-9_.-]*@{1}[A-Za-z0-9_.-]+.[A-Za-z0-9]+$/.test(this.value) == "false"){
    ...
    postcode.addEventListener("input",function(){
      ...
      if(/^[0-9]{3}-[0-9]{4}$/.test(this.value)){
        postcode_error.className = 'notError';
      } else if(/^[0-9]{3}-[0-9]{4}$/.test(this.value) == "false"){
        postcode_error.className = 'error';
      } 
    });
