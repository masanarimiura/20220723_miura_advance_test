      ...
      <table>
        ...
        <tr>
          ...
          <td colspan="2" class="postcode-box">
            <div>
              <span>〒</span><input type="text" name="postcode" value="{{ old('postcode') }}" class="postcode-box-input">
            </div>
        ...
        <tr>
          ...
          <td colspan="2">
            ...
            <input type="text" name="address" value="{{ old('address') }}" type="text" class="p-postal-code" size="8" maxlength="8">
