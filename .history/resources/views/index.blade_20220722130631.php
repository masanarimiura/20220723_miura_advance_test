    ...
    <form action="/" method="POST" class="h-adr">
      ...
      <table>
        ...
        <tr>
          <th>住所<span >※</span></th>
          <td colspan="2">
            <input type="text" name="address" value="{{ old('address') }}" class="p-region p-locality p-street-address p-extended-address opinion" id="address">
            <p class="example">例）東京都渋谷区千駄ヶ谷1-2-3</p>
            <p class="notError" id="opinion_error">※住所を120字以内で入力してください</p>
