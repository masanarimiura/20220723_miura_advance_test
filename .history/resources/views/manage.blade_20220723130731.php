...
.show-data table tr td form .reset-btn {
  border-radius: 6px;
  margin: 10px auto 0;
  padding-top: 5px;
  padding-bottom: 5px;
      ...
      <form action="/manage" method="POST">
        <table>
          ...
          <tr>
            <th>登録日</th>
            <td>
              <label class="date-edit"><input type="date" name="from_date" value="" /></label>
              <span>~</span>
            </td>
            <td>
              <label class="date-edit"><input type="date" name="until_date"  value="" /></label>
            </td>
          </tr>
          <tr>
            <th>メールアドレス</th>
        ...
        <div class="submit-box">
          <a href="{{ route('manage.manage') }}" class="reset-btn">リセット</a>
        </div>
      </form>
    </div>
    <div class="show-data">
